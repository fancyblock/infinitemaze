package Maze
{
	...
	public class Cell
	{
		...
		{
			m_wallExist[MazeDef.DIR_0] = true;
			m_wallExist[MazeDef.DIR_3] = true;
			m_wallExist[MazeDef.DIR_6] = true;
			m_wallExist[MazeDef.DIR_9] = true;
		}
		...
		public function Reset( open:Boolean ):void
		{
			...
			m_wallExist[MazeDef.DIR_0] = wallState;
			m_wallExist[MazeDef.DIR_3] = wallState;
			m_wallExist[MazeDef.DIR_6] = wallState;
			m_wallExist[MazeDef.DIR_9] = wallState;
		}
